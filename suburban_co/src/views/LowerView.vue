...
<div class="my-5 container" >
          <div class="row" style="margin-top: 3rem;" v-if="lower">
    <div class="car col-12 col-sm-6 col-md-4 p-2" v-for="product in lower" :key="product.product_id">
...
export default {
  ...
  computed: {
    lower() {
      return this.$store.state.lower;
    },
  },
  mounted() {
    this.$store.dispatch("fetchLower");
  },
};
</script>
